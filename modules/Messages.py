...
class Messages:
    ...
    def infoMessage(self, no):
        ...
        self.messages[102] = "Provide a valid email address (only used when requested a cluster)"
        ...
        self.messages[131] = "Provide a valid email address. Only used when requested a cluster"
        ...
        self.messages[143] = "Create a Weaviate cluster on the SeMI network"
        self.messages[144] = "Asynchronous in the background"
        self.messages[145] = "Do not set as default Weaviate url"
        self.messages[146] = "Delete a cluster"
        self.messages[147] = "Setting the cluster not as default URL"
        self.messages[148] = "Setting the cluster as default URL"
        self.messages[149] = "Replace and delete the current cluster if set?"
        self.messages[150] = "You already have a cluster present. Do you want to replace and delete the current one (y/n)? "
        self.messages[151] = "If no configuration is set, provide an email "
        self.messages[152] = "There are no clusters active for this email"
    ...
    def errorMessage(self, no):
        ...
        self.messages[217] = "You can't both create and remove a cluster"
        self.messages[218] = "Something is wrong with the SeMI cluster service, please check back later."
