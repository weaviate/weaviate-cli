...
class DataManager:
    ...
    def create_data(
        ...
        for tenant in tenants:
            ...
            if len(collection) - initial_lenght != limit:
                click.echo(
                    f"Error occurred while ingesting data for tenant '{tenant}'. Expected number of objects inserted: {limit}. Actual number of objects inserted: {len(collection) - initial_lenght}. Double check with weaviate-cli get collection"
                )
        return collection
